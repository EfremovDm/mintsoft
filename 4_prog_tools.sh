...
echo '================================= Установка редакторатекстов Sublime ===================================' 
...
echo '====================== Установка TeamViewer - диспетчер удаленного рабочего стола =====================' 
...
echo '=================================== Создание дополнительных ярлыков ==================================' 
echo "[Desktop Entry]
Version=1.0
Type=Application
Name=PhpStorm
